...
v30_multcostDIETER(ttot,all_regi)  "Cost markup factor for deviations from demand of last coupling iteration for DIETER coupling[-]"
...
q30_costAdjDIETER(ttot,all_regi)   "Improve convergence penalizing deviations from last coupling iteration for DIETER coupling"
$ENDIF.DTcoup
